# 原子記憶系統 Atomic Memory V2.9

> **Claude Code 跨 Session 知識管理引擎**
> Hybrid RECALL | Dual LLM | Workflow Guardian | Write Quality Gate | Wisdom Engine | ACT-R Activation
...
│
├── hooks/
│   ├── workflow-guardian.py          ← 統一 Hook 入口 (~2000 行)
...
### Vanilla Claude Code vs + Atomic Memory V2.9

| 指標 | Vanilla Claude Code | + Atomic Memory V2.9 |
|------|--------------------|-----------------------|
...
sequenceDiagram
    ...
    rect rgba(255,200,100,0.1)
        ...
        G->>G: [Q] 記錄 modified file 到 state
        G->>G: [R] sync_pending = true
