...
# (cwd_to_project_slug, get_project_memory_dir, find_project_root moved to wg_core.py)
...
# (Output helpers, _now_iso, _estimate_tokens, _atom_debug_log/error moved to wg_core.py)
