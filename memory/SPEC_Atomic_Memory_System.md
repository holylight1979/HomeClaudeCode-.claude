...
├─ v2.5 Keyword Boost: 大寫詞/引號短語/中文專有名詞 → 雙命中 +0.1 | 救回 +0.05
...
| 2.5 | 2026-03-06 | **V2.5**：Hybrid Search Keyword Boost（向量結果疊加 keyword matching，專有名詞召回率提升）+ Self-healing Collection Cache（ChromaDB 失效自動恢復） |
